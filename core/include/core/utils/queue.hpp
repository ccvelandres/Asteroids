...
namespace core::utils
{
#if (CORE_UTILS_QUEUE_USE_LOCKFREE && CORE_UTILS_QUEUE_ENABLE_LOCKFREE)
    template <typename T>
    using queue = atomic_queue<T>;
#elif (CORE_UTILS_QUEUE_USE_STDMUTEX && CORE_UTILS_QUEUE_ENABLE_STDMUTEX)
    template <typename T>
    ...
    template <typename T>
    using queue = atomic_queue<T>;
#elif (CORE_UTILS_QUEUE_ENABLE_STDMUTEX)
    template <typename T>
    using queue = mutex_queue<T>;
#else

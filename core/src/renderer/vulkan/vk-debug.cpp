#include <renderer/vulkan/vk-debug.hpp>
                                                      ...
                                                      const vk::DispatchLoaderDynamic &dispatcher )
{
    vk::DebugUtilsMessengerCreateInfoEXT
        createInfo( vk::DebugUtilsMessengerCreateFlagsEXT(),
                    vk::DebugUtilsMessageSeverityFlagBitsEXT::eError
                        | vk::DebugUtilsMessageSeverityFlagBitsEXT::eVerbose
                        | vk::DebugUtilsMessageSeverityFlagBitsEXT::eWarning,
...
VulkanDebugUtils::VulkanDebugUtils( const vk::Instance &instance )
    : m_internal( std::make_unique<Internal>( instance ) )
{
}

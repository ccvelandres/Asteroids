                            ...
                            const vk::ImageLayout    newLayout )
{
         ...
         && newLayout == vk::ImageLayout::eColorAttachmentOptimal )
    {
        ...
        L_TRACE(
            "Sending transition barrier for eUndefined -> eColorAttachmentOptimal" );
              ...
              && newLayout == vk::ImageLayout::eDepthStencilAttachmentOptimal )
    {
        ...
        L_TRACE(
            "Sending transition barrier for eUndefined -> eDepthStencilAttachmentOptimal" );
        commandBuffer->pipelineBarrier( vk::PipelineStageFlagBits::eTopOfPipe,
...
struct VulkanImage::Internal
{
    ...
    Internal( const VulkanPhysicalDevice    &physicalDevice,
        ...
        : width( width ),
          ...
          mipLevels( mipLevels ),
          format( format ),
          image( ::createImage( physicalDevice,
                                device,
                                width,
                                height,
                                mipLevels,
                                ...
                                usageFlags ) ),
          imageMemory(
              ::allocateImageMemory( physicalDevice, device, *image, memoryFlags ) )
    {

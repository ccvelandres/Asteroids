...
VulkanImage::VulkanImage( VulkanPhysicalDevice          &physicalDevice,
                          VulkanDevice                  &device,
                          ...
                          const vk::MemoryPropertyFlags &memoryFlags )
{
    ...
    m_imageMemory = allocateImageMemory( physicalDevice, device, *m_image, memoryFlags );
    L_TRACE( "Image allocated and created" );
}

VulkanImage::~VulkanImage() {}

vk::UniqueImage VulkanImage::createImage( VulkanPhysicalDevice          &physicalDevice,
                                          VulkanDevice                  &device,
                                          const uint32_t                 width,
                                          const uint32_t                 height,
                                          const uint32_t                 mipLevels,
...
vk::UniqueDeviceMemory VulkanImage::allocateImageMemory( VulkanPhysicalDevice &physicalDevice,
                                                         VulkanDevice         &device,
                                                         const vk::Image      &image,
                                                         const vk::MemoryPropertyFlags &memoryFlags )
{
    L_TAG( "VulkanImage::allocateImageMemory" );
